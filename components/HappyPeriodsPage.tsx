...
const HappyPeriodsPage: React.FC = () => {
    ...
    // ------------------------------------------------------------------------
    // HIGH-QUALITY, CUSTOM VECTOR ICONS 
    // Crafted for a premium, clean, and modern editorial aesthetic.
    // ------------------------------------------------------------------------
    ...
    const IconPad = () => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M12 8v8" strokeDasharray="2 2" opacity="0.5" />
        </svg>
    );
    ...
    const IconTampon = () => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <g transform="rotate(30 12 12)">
                ...
                <path d="M12 16v2" />
                <path d="M12 18c-1.5 1-1.5 2.5 0 3.5s-1.5 2.5 0 3.5" />
                <path d="M8 8h8" opacity="0.6" />
                <path d="M8 11h8" opacity="0.6" />
            </g>
        </svg>
    );
    ...
    const IconPanty = () => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M3 6h18" />
            <path d="M3 6c0 4.5 1.5 12 6 14 1 .45 2.5.5 3 .5s2-.05 3-.5c4.5-2 6-9.5 6-14" />
            <path d="M7 20C5 17 4.2 13 4 10" opacity="0.5" />
            <path d="M17 20c2-3 2.8-7 3-10" opacity="0.5" />
        </svg>
    );
    ...
    const IconUterus = () => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <circle cx="5" cy="5" r="1.5" fill="currentColor" fillOpacity="0.2" />
            <circle cx="19" cy="5" r="1.5" fill="currentColor" fillOpacity="0.2" />
        </svg>
    );
    ...
    // CLEAN, PROFESSIONAL SCATTER ARRANGEMENT
    const scatteredIcons = [
        { l: '8%', t: '12%', r: '15deg', Icon: IconCup, size: 56 },
        { l: '28%', t: '16%', r: '-8deg', Icon: IconCalendarDrop, size: 56 },
        { l: '48%', t: '10%', r: '12deg', Icon: IconUterus, size: 64 },
        { l: '72%', t: '15%', r: '-15deg', Icon: IconPad, size: 56 },
        { l: '90%', t: '22%', r: '20deg', Icon: IconHotWaterBottle, size: 56 },

        { l: '12%', t: '40%', r: '-12deg', Icon: IconPillPack, size: 56 },
        { l: '35%', t: '45%', r: '25deg', Icon: IconTampon, size: 56 },
        { l: '58%', t: '38%', r: '-8deg', Icon: IconPanty, size: 64 },
        { l: '80%', t: '42%', r: '15deg', Icon: IconDrop, size: 48 },

        { l: '10%', t: '70%', r: '18deg', Icon: IconUterus, size: 60 },
        { l: '32%', t: '78%', r: '-12deg', Icon: IconCup, size: 56 },
        { l: '55%', t: '70%', r: '8deg', Icon: IconHotWaterBottle, size: 56 },
        { l: '78%', t: '75%', r: '-20deg', Icon: IconCalendarDrop, size: 60 },

        { l: '20%', t: '90%', r: '-15deg', Icon: IconPad, size: 56 },
        { l: '50%', t: '92%', r: '15deg', Icon: IconPillPack, size: 56 },
        { l: '85%', t: '92%', r: '-5deg', Icon: IconTampon, size: 56 },
    ];

    return (
        <div className="min-h-screen bg-white relative" style={{ isolation: 'isolate' }}>

            {/* BACKGROUND: BOLD, CLEAN SVG ICONS */}
            <div className="fixed inset-0 pointer-events-none select-none z-0 overflow-hidden">
                {scatteredIcons.map((s, idx) => (
                    <div
                        key={idx}
                        className="absolute flex items-center justify-center text-stone-300 opacity-60 mix-blend-multiply"
                        style={{
                            left: s.l,
                            top: s.t,
