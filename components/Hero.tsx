      ...
      <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-start pb-8 md:pb-16">
        ...
        <div className="lg:col-span-7 space-y-10 z-10 flex flex-col items-start text-left">
          ...
          <p className="font-sans text-base md:text-lg text-stone-600 font-light leading-relaxed max-w-xl animate-in fade-in slide-in-from-left-12 duration-1000 delay-200">
            Three languages, one mission: <span className="text-stone-900 font-medium italic">making words hit differently!</span> I'm <span className="text-stone-900 font-medium">Sonakhi Malla (Rumi)</span>, your obsessive overthinking connoisseur who <span className="text-stone-900 font-medium">writes</span>, <span className="text-stone-900 font-medium">edits</span>, <span className="text-stone-900 font-medium">translates</span>, and <span className="text-stone-900 font-medium">guides</span> fellow budding word lovers discovering their voice. <span className="text-stone-900 font-medium italic">Khikhikhakhakhukhu!</span>
          </p>
