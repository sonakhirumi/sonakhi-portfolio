            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="space-y-8">
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="text-stone-700 leading-relaxed font-light text-lg space-y-4 text-justify">
                            <p>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-stone-700 leading-relaxed font-light text-lg text-justify">
