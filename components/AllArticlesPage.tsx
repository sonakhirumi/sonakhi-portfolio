...
const TRUBUDDY_BOOKS: BookItem[] = [
  { slug: 'needs-vs-wants', title: 'Needs vs Wants: Gulu Values Money', image: 'https://trubuddy.me/assets/Compressed-covers/5.jpg', url: 'https://trubuddy.me/c/needs-vs-wants', language: 'English' },
  { slug: 'use-internet-safely', title: 'How to Use the Internet Safely', image: 'https://trubuddy.me/assets/Compressed-covers/25.jpg', url: 'https://trubuddy.me/c/use-internet-safely', language: 'English' },
  { slug: 'using-time-smart', title: 'Using Time the Smart Way', image: 'https://trubuddy.me/assets/Compressed-covers/18.jpg', url: 'https://trubuddy.me/c/using-time-smart', language: 'English' },
  { slug: 'friends-shape-us', title: 'How Friends Shape Us', image: 'https://trubuddy.me/assets/Compressed-covers/12.jpg', url: 'https://trubuddy.me/c/friends-shape-us', language: 'English' },
  { slug: 'talk-confidently', title: 'How to Talk Confidently', image: 'https://trubuddy.me/assets/Compressed-covers/6.jpg', url: 'https://trubuddy.me/c/talk-confidently', language: 'English' },
  { slug: 'messy-to-organised', title: 'From Messy to Organised', image: 'https://trubuddy.me/assets/Compressed-covers/23.jpg', url: 'https://trubuddy.me/c/messy-to-organised', language: 'English' },
  { slug: 'bounce-from-failure', title: 'Bounce Back from Failure', image: 'https://trubuddy.me/assets/Compressed-covers/11.jpg', url: 'https://trubuddy.me/c/bounce-from-failure', language: 'English' },
  { slug: 'deal-with-challenges', title: 'How to Deal with Challenges', image: 'https://trubuddy.me/assets/Compressed-covers/26.jpg', url: 'https://trubuddy.me/c/deal-with-challenges', language: 'English' },
  { slug: 'good-eating-habits', title: 'Eating Habits for Good Health', image: 'https://trubuddy.me/assets/Compressed-covers/24.jpg', url: 'https://trubuddy.me/c/good-eating-habits', language: 'English' },
  { slug: 'overcome-screen-addiction', title: 'Mira Overcomes Screen Addiction', image: 'https://trubuddy.me/assets/Compressed-covers/30.jpg', url: 'https://trubuddy.me/c/overcome-screen-addiction', language: 'English' },
  { slug: 'art-make-friends', title: 'The Art of Making Friends', image: 'https://trubuddy.me/assets/Compressed-covers/20.jpg', url: 'https://trubuddy.me/c/art-make-friends', language: 'English' },
  { slug: 'talk-about-mistake', title: 'Made a Mistake? How to Talk About It', image: 'https://trubuddy.me/assets/Compressed-covers/15.jpg', url: 'https://trubuddy.me/c/talk-about-mistake', language: 'English' },
  { slug: 'learn-about-money', title: 'Learn about Money with Gulu', image: 'https://trubuddy.me/assets/Compressed-covers/21.jpg', url: 'https://trubuddy.me/c/learn-about-money', language: 'English' },
  { slug: 'junk-food-truth', title: 'Gulu Finds the Truth about Junk Food', image: 'https://trubuddy.me/assets/Compressed-covers/16.jpg', url: 'https://trubuddy.me/c/junk-food-truth', language: 'English' },
  { slug: 'memorisation-made-easy', title: 'Memorisation Made Easy', image: 'https://trubuddy.me/assets/Compressed-covers/14.jpg', url: 'https://trubuddy.me/c/memorisation-made-easy', language: 'English' },
  { slug: 'learns-healthy-food', title: 'Mira Learns about Healthy Food', image: 'https://trubuddy.me/assets/Compressed-covers/22.jpg', url: 'https://trubuddy.me/c/learns-healthy-food', language: 'English' },
  { slug: 'good-habits', title: 'How to Stick to Good Habits', image: 'https://trubuddy.me/assets/Compressed-covers/8.jpg', url: 'https://trubuddy.me/c/good-habits', language: 'English' },
  { slug: 'handle-cash-safely', title: 'Mira Learns to Handle Cash Safely', image: 'https://trubuddy.me/assets/Compressed-covers/19.jpg', url: 'https://trubuddy.me/c/handle-cash-safely', language: 'English' },
  { slug: 'how-to-read', title: 'How to Read for Better Learning', image: 'https://trubuddy.me/assets/Compressed-covers/2.jpg', url: 'https://trubuddy.me/c/how-to-read', language: 'English' },
  { slug: 'how-build-willpower', title: 'How to Build Willpower', image: 'https://trubuddy.me/assets/Compressed-covers/17.jpg', url: 'https://trubuddy.me/c/how-build-willpower', language: 'English' },
];
